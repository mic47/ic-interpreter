...
interpreter: src/interpreter.c src/interpreter.h o/lexer.o o/parser.o o/stack.o o/map.o o/memory.o
	$(GCC) $(CFLAGS) src/interpreter.c o/lexer.o o/parser.o o/stack.o o/map.o -o interpreter -lfl
